...
public:
    ...
    int startDownloadCloud(const QString& session, const QString& devSerial, const int iChannelNo, const QString& safekey, const QString& startTime, const QString& stopTime);
    int stopDownloadCloud(const QString& session);
    int startP2PDownload(const QString& session, const QString& devSerial, const int iChannelNo, const QString& safekey, const QString& startTime, const QString& stopTime);
    int stopP2PDownload(const QString& session);
    ...
    int getP2PDeviceInfo(const QString& accessId, const QString& devSerial, void** pBuf, int* length);
